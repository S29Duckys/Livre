    ...
    <div class="container">
        ...
        <form method="post" action="<?= "/createbook/" ?>" class="form-container">
            <div class="form-group">
                ...
                <input type="text" placeholder="Titre du livre" name="titre">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea placeholder="Description du livre" name="description"></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="url" placeholder="https://exemple.com" name="url">
            </div>
